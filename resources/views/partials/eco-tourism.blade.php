<!-- Eco-Tourism Module -->
<section id="eco-tourism" class="py-20 bg-white">
        ...
        <div class="grid lg:grid-cols-3 gap-8 mb-12">
                ...
                <div class="p-6">
                    ...
                    <div class="space-y-3 mb-4">
                        <div class="flex items-center text-sm">
                            <i class="fas fa-map-marker-alt text-green-primary mr-2"></i>
                            <span class="text-gray-600">Mountain Province</span>
                        </div>
                        <div class="flex items-center text-sm">
                            <i class="fas fa-users text-green-primary mr-2"></i>
                            <span class="text-gray-600">Max 50 visitors/day</span>
                        </div>
                        <div class="flex items-center text-sm">
                            <i class="fas fa-tree text-green-primary mr-2"></i>
                            <span class="text-gray-600">200+ species protected</span>
                        </div>
                    </div>
                    
                    <div class="mb-4">
                        <div class="flex justify-between items-center mb-1">
                            <span class="text-sm text-gray-600">Sustainability Score</span>
                            <span class="text-sm font-semibold text-green-primary">95%</span>
                        </div>
            ...
            <div class="bg-white rounded-lg shadow-xl overflow-hidden card-hover">
                ...
                <div class="p-6">
                    ...
                    <div class="space-y-3 mb-4">
                        <div class="flex items-center text-sm">
                            <i class="fas fa-map-marker-alt text-tech-blue mr-2"></i>
                            <span class="text-gray-600">Coastal Region</span>
                        </div>
                        <div class="flex items-center text-sm">
                            <i class="fas fa-solar-panel text-tech-blue mr-2"></i>
                            <span class="text-gray-600">100% renewable energy</span>
                        </div>
                        <div class="flex items-center text-sm">
                            <i class="fas fa-water text-tech-blue mr-2"></i>
                            <span class="text-gray-600">Coral reef protection</span>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        <div class="flex justify-between items-center mb-1">
                            <span class="text-sm text-gray-600">Sustainability Score</span>
                            <span class="text-sm font-semibold text-tech-blue">92%</span>
                        </div>
                        <div class="w-full bg-gray-200 rounded-full h-2">
                            <div class="bg-tech-blue h-2 rounded-full" style="width: 92%"></div>
                        </div>
                    </div>
                    
                    <button class="w-full bg-tech-blue text-white py-2 px-4 rounded-lg hover:bg-blue-600 transition">
                        Explore Destination
                    </button>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-xl overflow-hidden card-hover">
                ...
                <div class="p-6">
                    ...
                    <div class="space-y-3 mb-4">
                        <div class="flex items-center text-sm">
                            <i class="fas fa-map-marker-alt text-earth-brown mr-2"></i>
                            <span class="text-gray-600">Highland Territory</span>
                        </div>
                        <div class="flex items-center text-sm">
                            <i class="fas fa-mountain text-earth-brown mr-2"></i>
                            <span class="text-gray-600">2,500m elevation</span>
                        </div>
                        <div class="flex items-center text-sm">
                            <i class="fas fa-feather text-earth-brown mr-2"></i>
                            <span class="text-gray-600">150 endemic species</span>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        <div class="flex justify-between items-center mb-1">
                            <span class="text-sm text-gray-600">Sustainability Score</span>
                            <span class="text-sm font-semibold text-earth-brown">98%</span>
                        </div>
                        <div class="w-full bg-gray-200 rounded-full h-2">
                            <div class="bg-earth-brown h-2 rounded-full" style="width: 98%"></div>
                        </div>
                    </div>
                    
                    <button class="w-full bg-earth-brown text-white py-2 px-4 rounded-lg hover:bg-amber-700 transition">
                        Explore Destination
                    </button>
                </div>
            </div>
